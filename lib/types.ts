...
export type PublicTripSection='today'|'recap'|'explore'|'food';
export type TripCoverTheme='forest'|'lake'|'sunset';
export type TripSettings={title:string;destinations:string;startDate:string;endDate:string;publicMessage:string;coverTheme:TripCoverTheme;publicSections:PublicTripSection[]};
