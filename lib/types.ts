export type ItineraryItem={id:string,time:string,title:string,details?:string,done:boolean,optional?:boolean,mapUrl?:string,routeText?:string,confirmationNumber?:string,userNotes?:string};
