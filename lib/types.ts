...
export type CheckItem={id:string,title:string,category:string,done:boolean,notes?:string,triedAtPlaceId?:string,triedAt?:string,checklistType?:'prep'|'packing'|'bucket',dueDate?:string,completedAt?:string};
