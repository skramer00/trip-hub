...
const rawDays:TripDay[]=[
 {date:'2026-09-24',label:'Thu 9/24',city:'Toronto',items:[{id:'d1-1',time:'10:30 AM',timeZone:'America/Los_Angeles',title:'Leave for LAX',details:'Bring lunch or buy food after TSA.',done:false},{id:'d1-2',time:'2:20 PM',timeZone:'America/Los_Angeles',title:'Porter flight to Toronto Pearson',done:false},{id:'d1-3',time:'10:00 PM',timeZone:'America/Toronto',title:'Arrive and clear customs',done:false},{id:'d1-4',time:'Late',timeZone:'America/Toronto',title:'UP Express to Union and hotel check-in',done:false}]},
 ...
 {date:'2026-10-01',label:'Thu 10/1',city:'Travel home',items:[{id:'d8-1',time:'7:30 AM',timeZone:'America/Toronto',title:'Check out and head to Union',done:false},{id:'d8-2',time:'8:00 AM',timeZone:'America/Toronto',title:'UP Express to Pearson',done:false},{id:'d8-3',time:'11:00 AM',timeZone:'America/Toronto',title:'Flight to LAX',done:false}]}
];
const days=rawDays.map(day=>({...day,items:day.items.map(item=>({...item,...routeById[item.id]}))}));

export const initialState:TripState={
 settings:defaultTripSettings,
 dietaryPreferences:['low-fodmap'],
 days,
