...
import {dietaryFitLabel,dietaryFits,dietaryPreferenceLabel,dietaryPreferences,dietaryRating,isFoodPlace,placeMatchesDietaryFilter,setDietaryRating} from '@/lib/dietary';
